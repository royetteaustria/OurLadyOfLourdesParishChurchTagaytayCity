...
const UpdateBaptismalClient = () => {
  ...
  const update = (e: FormEvent) => {
    ...
    .then(res => {
      console.log(res)
      navigate('/ParishSecretary/BaptismalClient')
          ...
          <div className="rounded-sm   bg-white  dark:border-strokedark dark:bg-boxdark">
            <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
              ...
              <div className="mb-4.5">
                ...
                <div className="relative z-20 bg-transparent dark:bg-form-input">
                <select value={seminar} onChange={e => setSeminar(e.target.value)} className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus-border-primary active-border-primary dark-border-form-strokedark dark-bg-form-input dark-focus-border-primary">
                  <option value="Pending">Pending</option>
                  <option value="Complete">Complete</option>
                </select>
                </div>
