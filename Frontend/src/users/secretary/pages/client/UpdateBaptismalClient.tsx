...
import AddRecordModal from '../../../weddingAdmin/components/modal/NavigateToAddRecord/AddRecordModal'
            ...
            <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
              ...
              <div className="mb-4.5">
                ...
                <span className='w-full text-center py-8'>
                  <button type="submit" className="rounded-sm px-4 py-2 bg-primary flex text-center justify-center  w-full items-end text-white">
                    Update
                  </button>
                </span>
              </form>
