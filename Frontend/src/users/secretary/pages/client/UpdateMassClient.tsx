...
const UpdateMassClient = () => {
  ...
  useEffect (() => {
    axios.get(`https://our-lady-of-lourdes-parish-church-tagaytay-city-backend.vercel.app/api/MassClient/singleClient/`+id)
    .then(res => {
      console.log(res)
  ...
  const update = (e: FormEvent) => {
    e.preventDefault()
    axios.put(`https://our-lady-of-lourdes-parish-church-tagaytay-city-backend.vercel.app/api/MassClient/update/${id}`, { description, status })
    .then(res => {
      console.log(res)
  ...
  return (
    <>
    <Breadcrumb pageName='Update Client Status'/>
                ...
                {/* <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select value={description} onChange={e => setDescription(e.target.value)} className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus-border-primary active-border-primary dark-border-form-strokedark dark-bg-form-input dark-focus-border-primary">
                      <option value="Mass not be done">Mass not be done</option>
                      <option value="Mass Complete">Mass Complete</option>
                    </select>
                  </div> */}
                <div className="mb-4.5">
                <label className="mb-2.5 block text-black dark:text-white">
...
export default UpdateMassClient