...
export function EditMain({name, dateofBirth, birthPlace,  cellphoneNumber, currentAddress, fatherName, fatherBirthOfPlace, motherName, motherBirthOfPlace,  marriedPlace, updateFields}: MainInfoFormProps) {
  return (
    <>
