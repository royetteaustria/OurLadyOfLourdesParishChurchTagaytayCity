...
const BaptismRecord = ({}) => {
  ...
  useEffect(() => {
    async function getRecords() {
      const res = await axios.get(`https://our-lady-of-lourdes-parish-church-tagaytay-city-backend.vercel.app//api/BaptismalRecords/bapstismalRecordList`)
  ...
  async function deleteRecord(id: string) {
    await axios.delete(`https://our-lady-of-lourdes-parish-church-tagaytay-city-backend.vercel.app//api/BaptismalRecords/deletebaptismalRecords/${id}`)
      .then(() => {
