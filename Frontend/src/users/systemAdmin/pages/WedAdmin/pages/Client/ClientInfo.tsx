  ...
  return (
    ...
    <div className="ml-6 mt-6 border-t border-gray-100">
      <dl className="divide-y divide-gray-100">
        ...
        <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Baptismal_Certificate}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Confirmation_Certificate}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Birth_Certificate}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_CeNomar_Civil_Married}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Cannonical_Application}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Id_Picture}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Marriage_Banns}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Banns_Reply}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Groom_Marriage_Contract}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Baptismal_Certificate}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Confirmation_Certificate}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Birth_Certificate}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_CeNomar_Civil_Married}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Cannonical_Application}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Id_Picture}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Marriage_Banns}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Banns_Reply}`)}
        ...
        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <span>
          <button
          onClick={() => handleViewFile(`http://localhost:5000/${data.Bride_Marriage_Contract}`)}
