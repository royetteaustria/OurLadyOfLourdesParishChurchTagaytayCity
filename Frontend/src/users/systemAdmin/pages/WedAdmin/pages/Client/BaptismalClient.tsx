        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              ...
              <th className="min-w-[150px] py-4 px-12 font-medium text-black dark:text-white">
            ...
            {FilterClient.length > 0 ? (
              ...
              <tr key={index}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-4.5">
                  <h5 className={data.status === 'Complete' ? "font-medium text-success" : "font-medium text-danger"}>
                ...
                {/* <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <button className="">
                      <Link to={`/systemAdmin/BaptismalClientInfo/${data._id}`}>
                      <GoEye size={20}/>
                      </Link>
                    </button>
                    <button 
                     className="text-primary">
                      <Link to={`/systemAdmin/UpdateBaptismalClient/${data._id}`}>
                        Update
                      </Link>
                    </button>
                  </div>
