type Otherinfo = {
  ...
  export function EditOtherInfoRecord({RegistryNo, priestWhoMarried, timeOfMarriage, Province, City_Municipality, placeOfMarriage, dateOfMarriage, updateFields}: OtherInforFormProps) {
    return (
      <>
  ...
  export default EditOtherInfoRecord