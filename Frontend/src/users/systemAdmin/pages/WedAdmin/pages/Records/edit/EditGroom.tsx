type GroomUserData ={
  ...
  export function EditGroomForm({groomName, groomBirth, groomPlaceofBirth, groomSex, groomCitezenship, groomResidence, groomReligion, groomCivilStatus, groomNameofFather, groomFatherCitezenship, groomNameofMother, groomMotherCitezenship, groomNameOfPersonWhoGaveConcent, groomNameOfPersonWhoGaveConcentRelationship, groomPersonWhoGaveConcentResidence, updateFields}: GroomUserFormProps) {
    return (
      <>
