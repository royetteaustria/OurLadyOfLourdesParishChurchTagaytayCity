...
const EmptyStatesUsers = () => {
  ...
  <div className="max-w-4xl mx-auto px-10 py-4 dark:bg-boxdark bg-white rounded-lg ">
    <div className="flex flex-col justify-center items-center">
      ...
      <h1 className="text-gray-700 font-medium text-2xl text-center mb-3">No haven't users</h1>
      <p className="text-gray-500 text-center mb-6">Register users now!.</p>
...
export default EmptyStatesUsers