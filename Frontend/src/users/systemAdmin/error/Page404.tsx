...
const Page404 = () => {
  ...
  return (
    <div className="bg-whiten h-screen">
            <div className="flex items-center justify-center py-12">
                <div className="bg-whiten  rounded-md flex items-center justify-center mx-4 md:w-2/3 ">
                    <div className="flex flex-col items-center py-16 ">
                        ...
                        <button 
                        onClick={() => navigate(-1)}
                        className="mx-4 h-10 w-44 border rounded-md text-white text-base bg-primary hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-indigo-800">
                        Go Back
                        </button>
                    </div>
                </div>
