...
interface RejectBaptismalDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onDeleteConfirmed: (recordId: string) => void;
  inquireId: string | null;
}

const RejectBaptismal = ({isOpen,
  onClose,
  onDeleteConfirmed,
  inquireId,} : RejectBaptismalDialogProps) => {
  return (
            ...
            <div className="relative bg-white rounded-lg w-96 p-4">
              ...
              <div className="mt-4 flex justify-end space-x-2">
                ...
                <button
                  ...
                  onClick={() => onDeleteConfirmed(inquireId!)}
                >
                  Reject
                </button>
              </div>
...
export default RejectBaptismal