    ...
    axios
      ...
      .then((res) => {
        ...
        setRecord((prev) => ({
          ...
          groomNameOfPersonWhoGaveConcent:
            res.data.groomNameOfPersonWhoGaveConcent,
          groomNameOfPersonWhoGaveConcentRelationship:
            res.data.groomNameOfPersonWhoGaveConcentRelationship,
          groomPersonWhoGaveConcentResidence:
            res.data.groomPersonWhoGaveConcentResidence,
          ...
          brideNameOfPersonWhoGaveConcent:
            res.data.brideNameOfPersonWhoGaveConcent,
          brideNameOfPersonWhoGaveConcentRelationship:
            res.data.brideNameOfPersonWhoGaveConcentRelationship,
          bridePersonWhoGaveConcentResidence:
            res.data.bridePersonWhoGaveConcentResidence,
        ...
        <div className="ml-6 mt-6 border-t border-gray-100">
          <dl className="divide-y divide-gray-100">
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="lg:ml-48 md:ml-48 sm:ml-48 mt-1 text-sm leading-6 text-black dark:text-bodydark1 sm:col-span-2 sm:mt-0">
                {record.groomNameOfPersonWhoGaveConcent}
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-sm font-semibold leading-6 dark:text-bodydark1 text-black">
              ...
              <dd className="lg:ml-48 md:ml-48 sm:ml-48 mt-1 text-sm leading-6 text-black dark:text-bodydark1 sm:col-span-2 sm:mt-0">
                {record.groomNameOfPersonWhoGaveConcentRelationship}
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-sm font-semibold leading-6 dark:text-bodydark1 text-black">
              ...
              <dd className="lg:ml-48 md:ml-48 sm:ml-48 mt-1 text-sm leading-6 text-black dark:text-bodydark1 sm:col-span-2 sm:mt-0">
                {record.groomPersonWhoGaveConcentResidence}
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="lg:ml-48 md:ml-48 sm:ml-48 mt-1 text-sm leading-6 text-black dark:text-bodydark1 sm:col-span-2 sm:mt-0">
                {record.brideNameOfPersonWhoGaveConcent}
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-sm font-semibold leading-6 dark:text-bodydark1 text-black">
              ...
              <dd className="lg:ml-48 md:ml-48 sm:ml-48 mt-1 text-sm leading-6 text-black dark:text-bodydark1 sm:col-span-2 sm:mt-0">
                {record.brideNameOfPersonWhoGaveConcentRelationship}
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-sm font-semibold leading-6 dark:text-bodydark1 text-black">
              ...
              <dd className="lg:ml-48 md:ml-48 sm:ml-48 mt-1 text-sm leading-6 text-black dark:text-bodydark1 sm:col-span-2 sm:mt-0">
                {record.bridePersonWhoGaveConcentResidence}
              </dd>
            </div>

            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text-sm mt-8 font-bold leading-6 dark:text-bodydark1 text-black">
                Other Information
              </dt>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
