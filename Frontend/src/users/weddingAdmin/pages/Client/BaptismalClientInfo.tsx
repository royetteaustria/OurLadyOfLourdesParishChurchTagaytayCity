      ...
      <div className="bg-white p-6 dark:bg-boxdark dark:text-bodydark1">
        <div className="px-4 sm:px-0 ml-6 justify-between flex">
          <div>
            ...
            <p className={data.seminar === 'Pending' ? "mt-1 dark:text-bodydark1 max-w-2xl text-md leading-6 text-warning" : "mt-1 dark:text-bodydark1 max-w-2xl text-md leading-6 text-success"}>
             {data.seminar }
            </p>
          </div>
          <div className="mr-12">
            ...
            <p
              className={
                data.status === "Pending"
                  ? "font-medium text-[#Ffa500] dark:text-[#Ffa500]"
                  : data.status === "Complete"
                  ? "font-medium text-success dark:text-success"
                  : "font-medium text-danger dark:text-danger"
              }
            >
              {data.status}
            </p>
        ...
        <div className="ml-6 mt-6 border-t border-gray-100">
          <dl className="divide-y divide-gray-100">
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="lg:ml-40 md:ml-40 sm:ml-40 mt-1 text-sm leading-6 text-black dark:text-bodydark1 sm:col-span-2 sm:mt-0">
                {data.fatherName}
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
