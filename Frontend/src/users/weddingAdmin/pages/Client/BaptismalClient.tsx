import BaptismalNoclient from '../../components/other/BaptismalNoclient'
              ...
              <tr key={index}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <button className="">
                      <Link to={`/weddingAdmin/BaptismalClientInfo/${data._id}`}>
                      <GoEye size={20}/>
                      </Link>
                    </button>
                    {/* <button 
                     className="text-primary">
                      <Link to={`/weddingAdmin/UpdateBaptismalClient/${data._id}`}>
                        <FaRegEdit size={20} style={{color: '#3C50E0'}}/>
                      </Link>
                    </button> */}
                    {/* <button className="hover:text-primary text-primary">
                          <Link
                            to={`/weddingAdmin/ManageBaptismalRequirements/${data._id}`}
                          >
                            Manage Requirements
                          </Link>
                        </button> */}
