...
const UpdateBaptismalReq = () => {
  ...
  const upload = async (e: FormEvent) => {
    ...
    axios
      .put("https://our-lady-of-lourdes-parish-church-tagaytay-city-backend.vercel.app/api/Baptismalreq/update/"+id, formData)
      .then((res) => {
        console.log(res);
...
export default UpdateBaptismalReq;
