...
const ViewModal: React.FC<ViewModalProps> = ({ event, onDeleteEvent, onClose }) => {
  ...
  const GoToEditEvent = () => {
    navigate(`/weddingAdmin/editReservation/${event._id}`);
  }

  async function handleDeleteEvent() {
    try {
      await axios.delete(`https://ourladyoflourdes-parishchurch-tagaytay-city-server.vercel.app/api/CalendarReservation/delete/${event._id}`);
