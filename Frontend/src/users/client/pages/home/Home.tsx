       ...
       <div id="home" className="relative bg-white pb-[110px] pt-[120px] px-32 dark:bg-dark lg:pt-[150px]">
        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-5/12">
            <div className="hero-content" data-aos="fade-right" data-aos-offset="300" data-aos-duration="800" data-aos-easing="ease-in-sine">
              <h1
                className="mb-5 text-4xl font-bold !leading-[1.208] text-black dark:text-white sm:text-[42px] lg:text-[40px] xl:text-5xl"
              >
                Our <br />
                Lady of Lourdes <br />
                Parish Church.
              ...
              <p
                className="mb-8 max-w-[480px] text-black text-body-color dark:text-dark-6"
              >
                Our Lady of Lourdes Parish Church in Tagaytay is a popular choice for weddings due to its convenient location near Rotonda and charming atmosphere, making it perfect for family celebrations.
              </p>
