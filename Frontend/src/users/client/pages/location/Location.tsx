        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-12 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2
                className="mb-6 text-[32px] font-bold uppercase text-black  sm:text-[40px] lg:text-[36px] xl:text-[40px]"
              >
                GET IN TOUCH WITH US
              </h2>
              {/* <p
                className="mb-9 text-base leading-relaxed text-black dark:text-dark-6"
              >
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  4X64+FXR, Tagaytay - Nasugbu Hwy, Silang Junction North, Tagaytay, Cavite
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div
                  className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary/5 text-primary sm:h-[70px] sm:max-w-[70px]"
                >
                  <SlSocialFacebook size={30} style={{ color: '#3C50E0' }}/>
                </div>
                <div className="w-full">
                  <h4 className="mb-1 text-xl font-bold text-black dark:text-white">
                    Facebook
