...
const Services = () => {
  return (
    ...
    <div className="grid gap-8 px-32 row-gap-5 mb-8 md:row-gap-3 lg:grid-cols-3 sm:grid-cols-1 sm:w-full" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
      <Cards/>
    </div>
  </div>
  )
