              ...
              <form className="space-y-4" onSubmit={submitHandler}>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="bg-gray-50 border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div className="flex items-center justify-between">
                  <Link to="/emailverification">
                    <p className="text-sm font-medium text-primary hover:underline dark:text-primary">
                      Forgot password?
                    </p>
                  </Link>
                </div>
